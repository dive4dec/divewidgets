...
# -*- coding: utf-8 -*-
#
# divewidgets documentation build configuration file
#
...
_version_py = os.path.join(repo, 'divewidgets', '_version.py')
version_ns = {}
...
htmlhelp_basename = 'divewidgetsdoc'
...
latex_documents = [
    (master_doc, 'divewidgets.tex', 'divewidgets Documentation',
     'Chung Chan', 'manual'),
]
